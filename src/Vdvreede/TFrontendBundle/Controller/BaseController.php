...
class BaseController extends Controller {
    ...
    public function indexAction() {
        ...
        return $this->render('VdvreedeTFrontendBundle:{$entityName}:index.html.twig', array(
            'list' => $accounts
        ));
    }
    ...
    protected function processItem($account, $user, $view) {

        $form = $this->createForm($this->form, $account);
